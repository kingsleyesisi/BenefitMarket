...
const SMTP_HOST       = 'mail.nextrade.online';     // your cPanel mail host
const SMTP_PORT       = 587;
const SMTP_USERNAME   = 'info@nextrade.online';
...
<h3 class="text-xl font-semibold mb-2">Contact Information</h3>
          <div class="flex flex-col space-y-2">
            <p>Email: <a href="mailto:support@nextrade.online" class="text-gray-200 hover:underline">support@nextrade.online</a></p>
